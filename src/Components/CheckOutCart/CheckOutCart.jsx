      ...
      <div className="text-center flex-detail-cart">        
        ...
        <div className='description-name-button'>
          <h3 className='h3-size margin-bottom' > {product.name} </h3>
           ...
           <p className="text-start margin-bottom">Todos nuestros productos son confeccionado con materiales de altisima Calidad. Su producto cuenta con Garantía de Fabricación.</p>
        </div>
      </div>
    </div>
  );
